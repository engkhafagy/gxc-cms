...
<div class="section" style="border: 1px solid;padding: 9px;">
        <div class="title">
            <?php echo Yii::t('app', 'Permissions')?>
            <span class="hide"></span>
        </div>
                ...
                <div class="row">
                    <table>
                        <tr>
                            ...
                            <?php foreach($tableHeader as $kk1=>$vv1):?>
                            <td>
                                <?php echo $kk1;?>
                            </td>
                            <?php endforeach;?>
                            ...
                            <td>
                                ...
                                if(isset($v[$k.'.'.$kk1])){
                                    if($v[$k.'.'.$kk1]){
                                        ...
                                        $url = $this->createUrl('roles/grant',array('id'=>$_GET['id'], 'obj'=> $k.'.'.$kk1,'stat'=>'0'));
                                        $title = Yii::t('app', 'Click to remove');
                                        $stat = 0;
                                    }else{
                                        $img = Yii::app()->request->baseUrl.'/images/remove.png';
                                        $url = $this->createUrl('roles/grant',array('id'=>$_GET['id'], 'obj'=> $k.'.'.$kk1,'stat'=>'1'));
